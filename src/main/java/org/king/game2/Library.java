...
public class Library {
    ...
    public ArrayList<String> func1() {
        ...
        result.add(plataforma.greet("game2"));
        result.add(plataformaConsumer1.greet("game2"));
        result.add(libDep1.greet("game2"));
        return result;
    }
    public ArrayList<String> func2() {
        ...
        ArrayList<String> result = new ArrayList<>();
        result.add(plataforma.greet("game2"));
        result.add(plataforma.greet1("game2"));
        result.add(plataforma.greet2("game2"));
        result.add(plataformaConsumer1.greet("game2"));
        result.add(libDep1.greet("game2"));
        return result;
    }
    public String unused1(String name) {
        return "unused1 from game2, " + name;
    }
    public String unused2(String name) {
        return "unused2 from game2, " + name;
    }
    public String unused3(String name) {
        return "unused3 from game2, " + name;
    }
    public String unused4(String name) {
        return "unused5 from game2, " + name;
    }
    public String unused5(String name) {
        return "unused5 from game2, " + name;
    }
    public String unused6(String name) {
        return "unused6 from game2, " + name;
    }
    public String unused7(String name) {
        return "unused7 from game2, " + name;
    }
    public String unused8(String name) {
        return "unused8 from game2, " + name;
    }    
    public String unused9(String name) {
        return "unused9 from game2, " + name;
    }
}